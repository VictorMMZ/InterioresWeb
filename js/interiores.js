        const dataByStyle = {
            ...
            bohemio: {
                ...
                cards: [
                    { room: "Salon creativo", note: "Cojines con patrones y obras en galeria.", image: "./images/bohemio/salon-bohemio.jpg" },
                    { room: "Cocina bohemia", note: "Butaca vintage y lampara calida.", image: "./images/bohemio/cocina-bohemio.jpg" },
                    { room: "Dormitorio chill", note: "Fibras, faroles y vegetacion abundante.", image: "./images/bohemio/dormitorio-bohemio.jpg" }
                ]
            },
            industrial: {
                title: "Galeria Industrial",
                description: "Materiales honestos: metal, hormigon y madera oscura.",
                intro: "La decoracion industrial apuesta por la autenticidad de los materiales y por una estetica urbana con caracter. Metal negro, madera oscura, cuero, cemento y acabados minerales se combinan para crear espacios con personalidad fuerte y un lenguaje contemporaneo. Para equilibrar esa base robusta, conviene introducir luz calida, textiles tactiles y piezas puntuales que suavicen el conjunto sin perder identidad. Tambien funciona muy bien jugar con contrastes: elementos estructurales visibles frente a mobiliario comodo, o tonos profundos combinados con superficies claras para mantener legibilidad visual. El resultado es un ambiente sofisticado, practico y contundente, perfecto para quien busca una imagen moderna con sensacion de permanencia y estilo atemporal.",
                introImage: "./images/industrial/industrial-intro.jpg",
                cards: [
                    { room: "Loft urbano", note: "Muros de ladrillo y estanterias metalicas.", image: "./images/industrial/salon-industrial.jpg" },
                    { room: "Cocina factory", note: "Taburetes altos y luminarias de hierro.", image: "./images/industrial/cocina-industrial.jpg" },
                    { room: "Dormitorio robusto", note: "Escritorio robusto y cuero envejecido.", image: "./images/industrial/dormitorio-industrial.jpg" }
                ]
            }
        };
        ...
        const panoramaImages = [
            { image: "images/panoramicas/panoramica1.jpg", alt: "Vista panoramica de sala principal" },
            { image: "images/panoramicas/panoramica2.jpg", alt: "Vista panoramica de comedor y cocina" },
            { image: "images/panoramicas/panoramica3.jpg", alt: "Vista panoramica de salon" }
        ];
        ...
        function App() {
            ...
            return (
                <main className="wrap">
                    ...
                    <nav className="quick-nav" aria-label="Navegacion rapida de secciones">
                        {navItems.map((item) => (
                            <button
                                key={item.key}
                                className={`quick-nav-btn ${activeSection === item.key ? "active" : ""}`}
                    ...
                    {showWelcome && (
                        ...
                        >
                            <div className="welcome-layout">
                                ...
                                <div className="welcome-middle-action">
                    ...
                    <section
                        className="price-section reveal from-top"
                        data-reveal
                    ...
                    >
                        <div className="section-head">
                            ...
                            <p>Estimaciones orientativas segun tamano y ejemplos visuales para cada opcion.</p>
                        </div>
                                        ...
                                        {roomGroup.plans.map((plan, planIndex) => (
                                            <div className="plan-variant" key={`${roomGroup.room}-${plan.name}`}>
                                                ...
                                                <img
                                                    ...
                                                    onError={(event) => {
                                                        event.currentTarget.removeAttribute("src");
                                                        event.currentTarget.alt = "Espacio para imagen de referencia";
                                                    }}
                                                />
                                            </div>
                                        ))}
